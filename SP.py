...
with interactive_plot_4:
    ...
    payment_options = df3['Type'].unique().tolist()
    payment = st.multiselect("Which payment method would you like to see?", payment_options,['Cash', 'Credit'])
    fig3 = fig3[fig3['Type'].isin(payment)]
    st.write(fig3)
