...
df = pd.read_csv (r'/Users/sallyharb/Desktop/Assignment 2/Data/student_scores.csv')
df1 = pd.read_csv (r'/Users/sallyharb/Desktop/Assignment 2/Data/smoke_detection_iot.csv')
df2 = pd.read_csv (r'/Users/sallyharb/Desktop/Assignment 2/Data/Breast_Cancer.csv')
df3 = pd.read_csv (r'/Users/sallyharb/Desktop/Assignment 2/Data/vending_machine_sales.csv')
df4 = pd.read_excel(r'/Users/sallyharb/Desktop/Assignment 2/Data/Kerala data.xlsx')
...
with interactive_plot_4:
    payment_list = ['All'] + df3['Type'].unique().tolist()
    st.title("Do people pay more using cash or card when using vending machines?")
    st.write("You can choose the type from the box")
    s_selected = st.selectbox("Which type do you want to choose for the filter?", payment_list, key="")
    st.write("You selected : " + str(s_selected))
    if s_selected != "All":
        display_data = df3[df3["Type"] == s_selected]
        
    else:
        display_data = df3.copy()
        
    fig8 = px.bar(df3, display_data, title = "Vending Machine Sales Methods of Payment")
    fig8.update_layout(plot_bgcolor="#F6E4D2")
