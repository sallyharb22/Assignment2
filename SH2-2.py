...
vis4= st.radio('Select', ['Reported','Active'],key='2')

if vis4== 'Recovered':
    fig4 = px.line(df4, x = "date", y = "Reported", title = "Reported and Actie COVID-19 Cases in Kerala")

if vis4== 'Active':
    fig4 = px.line(df4, x = "date", y = "Active", title = "Reported and Active COVID-19 Cases in Kerala")
...
with interactive_plot_5:
    st.header("How many reported and active COVID-19 cases where there in Kerala in 2020?")
